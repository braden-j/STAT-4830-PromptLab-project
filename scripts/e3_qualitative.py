"""
scripts/e3_qualitative.py — Experiment E3: Qualitative evaluation of step_500 checkpoint
...
Output: outputs/e3_qualitative.txt
"""
...
OUT_PATH        = os.path.join(_REPO_ROOT, "outputs", "e3_qualitative.txt")
N_ESSAYS        = 10
MAX_NEW_TOKENS  = 512
MIN_WORDS       = 80
MAX_WORDS       = 250
